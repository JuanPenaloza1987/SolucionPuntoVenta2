...
namespace SRATAPV.Ventas.Vista
{
    public partial class frmCorteCaja : Form
    {
        ...
        private void btnRealizarCorte_Click(object sender, EventArgs e)
        {
            ...
            if (lblEfectivo.Text == lblTotalDenominaciones.Text || lblEfectivo.Text == "0.00")
            {
                if (cmbCortes.Text != "")
                {
            ...
            {
                MessageBox.Show("El monto ingresado no correspone al monto de las ventas.", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
